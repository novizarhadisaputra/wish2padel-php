...
// Combine Partner + Premium for long cards
$topSponsors = array_merge($partnerSponsors, $premiumSponsors);
?>
  ...
  <div class="container">
    ...
    <?php if (!empty($topSponsors)): ?>
      <div class="sponsor-category mb-5">
        ...
        <?php foreach ($topSponsors as $row): ?>
          <div class="pp-partner-card">
            <div class="pp-partner-row">
              ...
              <div class="pp-content">
                <?php if ($row['type'] === 'partner'): ?>
                  <span class="badge bg-warning text-dark mb-2">PARTNER</span>
                <?php elseif ($row['type'] === 'premium'): ?>
