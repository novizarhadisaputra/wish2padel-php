...
// Ambil data pemain tanpa duplikat berdasarkan player_name + team_name
$sql = "
    SELECT 
        tmi.player_name,
        tmi.age,
    ...
    JOIN team_info ti ON ti.id = tmi.team_id
    GROUP BY tmi.player_name, ti.team_name
    ORDER BY tmi.player_name ASC
";
