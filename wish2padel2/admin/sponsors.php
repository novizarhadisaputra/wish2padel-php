...
<!-- ======================= ALL SPONSOR MODALS MOVED HERE ======================= -->
<?php foreach($sponsorModals as $row): ?>
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="sponsor_name" class="form-control" value="<?= htmlspecialchars($row['sponsor_name']) ?>" required>
          </div>

          <div class="mb-3">
            <label class="form-label">Website</label>
            <input type="url" name="website" class="form-control" value="<?= htmlspecialchars($row['website']) ?>">
          </div>
          ...
          <div class="mb-3">
            ...
            <select name="status" class="form-select status-select" data-target="type-wrapper-<?= $row['sponsor_id'] ?>" required>
          ...
          <div class="mb-3" id="type-wrapper-<?= $row['sponsor_id'] ?>" style="<?= ($row['status']=='sponsor') ? 'display:block' : 'display:none' ?>">
...
document.addEventListener("DOMContentLoaded", function() {
  document.querySelectorAll(".status-select").forEach(select => {
    select.addEventListener("change", function() {
      ...
      typeWrapper.style.display = (this.value === "sponsor") ? "block" : "none";
    });
  });
});
</script>
