  ...
  <div class="card-body">
    <form method="get" class="row g-3 align-items-end">
      <div class="col-md-4">
        ...
        <input type="number" id="match_id" name="match_id" class="form-control"
               placeholder="Enter Match ID" value="<?= htmlspecialchars($filter_match_id) ?>">
      </div>
    ...
    <div class="card-body bg-white">
      <table class="table table-bordered text-center align-middle mb-4">
        <thead class="table-light">
          <tr><th>Pair #</th><th>Team</th><th>Players</th><th>Scores</th></tr>
        </thead>
        <tbody>
          <?php
...
<!-- ======================= ALL EDIT SCORE MODALS MOVED HERE ======================= -->
<?php foreach($modalMatches as $match): ?>
