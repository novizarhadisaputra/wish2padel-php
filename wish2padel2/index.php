<?php
    ...
    // Ambil semua tournament berdasarkan tahun liga (patokan: l.date) sesuai tahun Riyadh
    $result = $conn->query("
        SELECT t.*, l.date, l.name AS league_name
        FROM tournaments t
        JOIN league l ON t.id_league = l.id
        WHERE YEAR(l.date) = YEAR(CURDATE())  -- ini sudah pakai timezone +03:00
...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content="https://www.wish2padel.com/assets/image/w2p logo.jpeg" />
    ...
    <body>
        ...
        <section id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3500" aria-label="Hero Image Carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                  <div class="hero" style="background-image: url('assets/image/mainpage.jpg');">
        ...
        <!--  <div class="hero" style="background-image: url('https://prested.co.uk/wp-content/webp-express/webp-images/uploads/2023/11/What-is-a-Padel-Tennis-Club.png.webp');">-->
        <!--    <div class="hero-text text-end">-->
        <!--      <h6 class="animate-text delay-1">LEAGUE & TOURNAMENTS</h6>-->
        <!--      <h1 class="animate-text delay-2">COMPETE & CONNECT</h1>-->
        <!--      <p class="animate-text delay-3">Join exciting leagues and tournaments designed for all skill levels — where every match is a new story.</p>-->
        <!--    </div>-->
        <!--  </div>-->
        <!--</div>-->
      </div>
          ...
          <div class="container-fluid" style="width:95%">
            <div class="row ">
              <div class="col-md-6 mb-4 mb-lg-0">
                <div class="row g-3">
                    <img src="assets/image/tournament.jpg"
                         alt="Tournament 1"
                         class="w-100 h-100"
              ...
              <div class="col-lg-6 text-white">
                ...
                <a href="regis.php" class="btn fw-bold px-4 py-2 mt-5"
