...
<head>
  ...
  <link rel="icon" href="<?= asset('assets/image/w2p%20logo.jpeg') ?>" type="image/png">
...
<section class="container py-5">
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-md-end">
        <p class="mb-1"><strong>Home:</strong>
          <a href="<?= asset('team_profile?id='.$match['team1_id']) ?>" class="text-decoration-none" style="color:#88604A;">
            <?= htmlspecialchars($match['team1']) ?>
          </a>
        </p>
        <p class="mb-0"><strong>Away:</strong>
          <a href="<?= asset('team_profile?id='.$match['team2_id']) ?>" class="text-decoration-none" style="color:#88604A;">
  ...
  $stmt_results->bind_param("i", $match['match_id']);
