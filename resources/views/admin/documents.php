...
<div class="container py-5 mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="text-gold mb-0">Manage Documents</h2>
    ...
    <div class="modal-content shadow-lg border-0">
      ...
      <div class="modal-footer border-0">
        ...
        <form method="POST" action="<?= asset('admin/documents') ?>">
            ...
            <button type="submit" class="btn btn-danger px-4">Delete Document</button>
        </form>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dark">
    <div class="modal-content border-0">
      <div class="modal-header border-0">
        <h5 class="modal-title text-gold"><i class="bi bi-plus-circle me-2"></i>Add Document</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <form method="POST" enctype="multipart/form-data" action="<?= asset('admin/documents') ?>">
        <div class="modal-body">
        ...
        <div class="modal-footer border-0">
          <button type="button" class="btn btn-secondary px-4" data-bs-dismiss="modal">Cancel</button>
          <button type="submit" name="add" class="btn btn-admin-gold px-4">Save Document</button>
        </div>
      </form>
    </div>
  </div>
